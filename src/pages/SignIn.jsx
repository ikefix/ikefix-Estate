      ...
      <div className='flex justify-center flex-wrap'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form onSubmit={onSubmit} >
            ...
            <button type='submit' className='w-full bg-blue-600 text-white px-8 py-2 border-r-2 text-sm font-medium uppercase rounded shadow-sm hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800'>Sign in</button>
